...
class _SubscriptionsScreenState extends State<garage> {
  final List<Map<String, dynamic>> subscriptions = [
    {
      "name": "البوابات والجراجات",
      "photos": [
        "assets/images/oo.jpg",
      ],
      "location": "https://forms.gle/UWcEBE3mbUWxrgD27",
      "menu": "https://drive.google.com/file/d/12DpghCsiqiRXBhY77mRF1yVimnlAJ57w/view?usp=sharing",
      "prices": "https://drive.google.com/file/d/12DpghCsiqiRXBhY77mRF1yVimnlAJ57w/view?usp=sharing", // URL for prices form
      "openTime": "طوال اليوم",
    },
  ];
