...
import 'package:Tibarosehouse/tagmooscreens/tagmoohotels.dart';
import 'package:Tibarosehouse/tagmooscreens/tagmoorestaurant.dart';
import 'package:carousel_slider/carousel_slider.dart';
import 'package:google_fonts/google_fonts.dart';

import '../alnozhascreens/OffersScreen.dart';
import '../alnozhascreens/RestaurantsScreen.dart';
import '../alnozhascreens/SubscriptionsScreen.dart';
import '../alnozhascreens/contact.dart';
import '../alnozhascreens/dryclean.dart';
import '../alnozhascreens/grandstores.dart';
...
class Tibarosetagmooscreen extends StatelessWidget {
  // Header with Carousel Image Slider
  Widget buildHeader(BuildContext context) {
    List<String> imgList = [
      'assets/images/plazahotel2.jpg',
      'assets/images/plazahotel1.jpg',
      'assets/images/plazagarden1.jpg',
      'assets/images/plazhotel3.jpg',
      'assets/images/plazagarden2.jpg.jpg',
    ];
  ...
  Widget buildCategories(BuildContext context) {
    List<Map<String, dynamic>> categories = [
      {"icon": Icons.restaurant_rounded, "label": "المطاعم", "screen": tagmooRestaurantsScreen()},
      {"icon": Icons.bed, "label": "الفنادق", "screen": TagmoohotelScreen()},
