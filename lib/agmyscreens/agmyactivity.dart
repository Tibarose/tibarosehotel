...
class AgmyActivityScreen extends StatelessWidget {
  final Map<String, dynamic> activity = {
    "name": "الأنشطة",
    "photos": [
      "https://i.imghippo.com/files/loHJ4578q.jpg",
      "https://i.imghippo.com/files/ckFZ1146XlU.jpg",
      "https://i.imghippo.com/files/pw3284je.jpg",
      "https://i.imghippo.com/files/bFf1266YrU.jpg",
    ],
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 8),
                        ElevatedButton.icon(
                          onPressed: () => _launchURL(activity["location"]),
                          icon: Icon(Icons.location_on, color: Colors.black),
                          label: Text("موقع النشاط", style: GoogleFonts.cairo(fontSize: 14, fontWeight: FontWeight.bold)),
                        ),
                        SizedBox(height: 8),
                        ElevatedButton.icon(
                          onPressed: () => _launchURL(activity["booking"]),
                          icon: Icon(Icons.book_online, color: Colors.black),
                          label: Text("طلب حجز", style: GoogleFonts.cairo(fontSize: 14, fontWeight: FontWeight.bold)),
                        ),
                      ],
                    ),
                  ],
